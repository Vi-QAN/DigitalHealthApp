...
namespace Contracts.Contracts.DigitalHealth
{
    public partial class DigitalHealthService
    {
        ...
        public Task<GetUserOutputDTO> GetUserQueryAsync(string u, BlockParameter blockParameter = null)
        {
        ...
        public Task<byte[]> LoginQueryAsync(byte[] email, byte[] password, BlockParameter blockParameter = null)
        {
            var loginFunction = new LoginFunction();
                loginFunction.Email = email;
